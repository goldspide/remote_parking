...
class AppColors{
  static final Color texrColor = const Color(0xFFccc7c5);
  ...
  static final Color pureColor = const Color(0xff50c2c9);
  static final Color backGround = const Color(0xffe5e5e5);
